...
import { area, line, curveBasis, curveCatmullRom } from 'd3-shape'
...
export const SashimiPlot = ({
  ...
  const generateCoverageGraphics = () => {
    ...
    return <path fill="blue" d={coverageCurve} />
  }
  ...
  const generateJunctionGraphics = () => {
    ...
    const generateJunctionCurveAndLabel = (junction, i, n, maxJunctionReads) => {
      ...
      const points = [
        [xPixelStart, y0_pixel - 2],
        [xPixel1, yPixel],
        [xPixel2, yPixel],
        [xPixelEnd, y0_pixel - 2],
      ]
      ...
      return [
        <g key={junction}>
          ...
          <path stroke="blue" strokeWidth={strokeWidth} fill="none" d={junctionCurve} />
        </g>,
        <g key={junction}>
