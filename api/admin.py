...
from api.models import GeneInfo, dbNSFPGene, GeneConstraint, TranscriptInfo, Omim
...
for model_class in [GeneInfo, dbNSFPGene, GeneConstraint, TranscriptInfo, Omim]:
